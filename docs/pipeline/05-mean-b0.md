...
**Further reading:** [FSL TOPUP User Guide](https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/topup/TopupUsersGuide) — Covers the full TOPUP workflow including how corrected B0 volumes are produced and averaged
